...
from podtext.core.processor import remove_advertisements, ADVERTISEMENT_MARKER
    ...
    **Validates: Requirements 4.4, 4.5, 7.6**
    ...
    def test_markdown_contains_valid_yaml_frontmatter(
        ...
        **Validates: Requirements 4.4, 4.5, 7.6**
        ...
        assert len(parts) >= 3, (
            "Markdown should have opening and closing '---' delimiters"
        )
        ...
        assert data["pub_date"] == expected_date, (
            f"pub_date should match episode date. Expected '{expected_date}', got '{data['pub_date']}'"
        )
        ...
        assert data["summary"] == analysis.summary, (
            f"Summary should match analysis summary"
        )
        ...
        assert data["topics"] == analysis.topics, (
            f"Topics should match analysis topics"
        )
        ...
        assert data["keywords"] == analysis.keywords, (
            f"Keywords should match analysis keywords"
        )
    ...
    def test_markdown_includes_optional_podcast_name(
        ...
        **Validates: Requirements 4.5**
        ...
        assert "podcast" in data, (
            f"Frontmatter should contain 'podcast' field when podcast_name is provided"
        )
    ...
    **Validates: Requirements 6.2, 6.3**
    ...
    def test_single_ad_removal_and_marker(
        ...
        **Validates: Requirements 6.2, 6.3**
        ...
        assert ad_content not in result, (
            f"Ad content '{ad_content}' should not be in result"
        )
    ...
    def test_no_ads_returns_original_text(
        ...
        **Validates: Requirements 6.2, 6.3**
        ...
        assert ADVERTISEMENT_MARKER not in result, (
            f"No markers should be present when no ads removed"
        )
    ...
    def test_multiple_ads_multiple_markers(
        ...
        **Validates: Requirements 6.2, 6.3**
        ...
        assert marker_count == 2, (
            f"Expected 2 markers, got {marker_count}. Result: '{result}'"
        )
